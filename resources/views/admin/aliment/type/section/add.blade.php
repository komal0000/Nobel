...
@section('title')
    ...
    <a href="{{route('admin.aliment.type.section.index',['type_id'=>$type_id])}}">Section</a> /
    <span>Add</span>
@endsection
@section('content')
    <div class="p-4">
        <form action="{{route('admin.aliment.type.section.add',['type_id'=>$type_id])}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-2">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="show_on_frontend" id="show_on_frontend" class="form-check-input" value="1">
                            </div>
                        </div>
