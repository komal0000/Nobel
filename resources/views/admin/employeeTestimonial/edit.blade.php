...
@endsection
@section('content')
    <form action="{{ route('admin.employeeTestimonial.edit', $EmployeeTestimonial->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="col-md-12 mb-3">
                    <label for="image">Image <span style="color: red;">*</span></label>
                    <input type="file" class="form-control dropify" id="image" name="image" accept="image/*" data-default-file="{{Storage::url($EmployeeTestimonial->image)}}">
                </div>
            </div>
            <div class="col-md-6">
