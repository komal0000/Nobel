            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text" class="form-control" id="title" name="title" required value="{{ $package->title ?? '' }}">
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" class="form-control" id="age" name="age" value="{{ $package->age ?? '' }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" class="form-control" id="labtest" name="labtest" value="{{ $package->labtest ?? '' }}">
                        </div>
                    </div>
                </div>
            </div>
