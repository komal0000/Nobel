...
@endsection
@section('content')
    <form action="{{ route('admin.service.section.edit', ['service_id' => $service->id, 'section_id' => $section->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="short_desc1" id="short_desc1" class="form-control" rows="3" required>{{ $section->short_desc1 }}</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label for="short_desc2">Description 2</label>
                    <textarea name="short_desc2" id="short_desc2" class="form-control" rows="3">{{ $section->short_desc2 }}</textarea>
                </div>
            </div>
