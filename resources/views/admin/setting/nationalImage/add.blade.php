            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="desktop_image">Desktop Image (1920x1200px) <span style="color: red;">*</span></label>
                        <input type="file" class="form-control dropify" id="desktop_image" name="desktop_image"
                            accept="image/*" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="mobile_image">Mobile Image (1440x1920px) <span style="color: red;">*</span></label>
