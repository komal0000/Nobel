...
<form action="{{ route('admin.slider.add') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="file" class="form-control dropify" id="desktop_image" name="desktop_image" accept="image/*">
        </div>
        <div class="col-md-6 mb-3">
            <label for="mobile_image">Mobile Image</label>
            <input type="file" class="form-control dropify" id="mobile_image" name="mobile_image" accept="image/*">
        </div>
