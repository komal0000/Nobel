    ...
    <form>
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="technology_short_description" id="technology_short_description" class="form-control" required>
            </div>
        </div>
                                ...
                                <div class="accordion-body" style="background: white">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="designType_{{ $type->id }}">Design Type <span style="color: red;">*</span></label>
                                                    <select name="designType" id="designType_{{ $type->id }}" class="form-control" required>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="short_description_{{ $type->id }}">Short Description <span style="color: red;">*</span></label>
                                                    <textarea name="short_description" id="short_description_{{ $type->id }}" class="form-control" required></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-3 d-flex justify-content-end">
                                                <button type="button" class="btn btn-sm btn-primary btn-active" onclick="toggleSectionData(event, {{ $type->id }})">
                                                    Manage Section Data
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-3" id="sectionData_{{ $type->id }}" style="display: none">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="file" name="image" id="section_image_{{ $type->id }}" class="form-control dropify"
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="title" id="section_title_{{ $type->id }}" class="form-control" required>
                                                </div>
                                                <div class="col-md-12 mb-3">
