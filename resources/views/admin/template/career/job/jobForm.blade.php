...
<section id="job-form-form">
    <div class="main-container">
        ...
        <div class="form-content-container">
            ...
            <form action="{{ route('jobs.jobDetail.form', $job->slug) }}" id="multiStepForm" class="form-container"
                ...
                <div class="form-step professional-detail-form" id="form-step-2">
                    <div class="row g-4">
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="text" name="orgName" class="form-control" placeholder="E.g. Hamro Hospital">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <label for="currentCost">Current Annual CTC (LPA)</label>
                            <input type="text" name="currentCost" class="form-control" placeholder="E.g. 5,00,000">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <label for="expectedCost">Expected Annual CTC (LPA)</label>
                            <input type="text" name="expectedCost" class="form-control" placeholder="E.g. 7,00,000"
                                >
                        </div>
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="text" name="currentDesignation" class="form-control"
                                placeholder="E.g. Associate, Senior Associate">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <label for="department">Department</label>
                            <input type="name" name="department" class="form-control"
                                placeholder="E.g. Doctor, Nurse" >
                        </div>

                        <div class="mb-3 col-lg-4">
                            <label for="yearExp">Total Years of Experience</label>
                            <input type="number" name="yearExp" class="form-control"
                                placeholder="Enter Your Experience">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <label for="changeReason">Reason of Change</label>
                            <input type="name" name="changeReason" class="form-control"
                ...
                <div class="form-step education-qualification" id="form-step-3">
                    <div class="row g-4">
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="text" name="securedPercent" class="form-control"
