<section id="event-list" data-content="event List">
    <div class="main-container">
        <div class="heading text-center mb-4">{{ $eventType->title }}</div>
        <div class="filters">
        ...
        <div class="event-content">
            <div class="row g-2" id="event-cards">
                @php
                    $events = App\Models\Blog::where('blog_category_id', $eventType->id)->get();
                @endphp
                        ...
                        <div class="slide m-3">
                            ...
                            <div class="body">
                                ...
                                <div class="d-flex justify-content-between know-btn">
                                    <x-hoverBtn href="{{ route('event.single', ['slug' => $item->slug]) }}">View
                                        Details</x-hoverBtn>
                                </div>
                            </div>
                        </div>
