                ...
                <div class="case-study">
                    ...
                    <div class="case-study-header">
                        ...
                        <div class="share-links d-flex gap-3 fs-2 mb-4">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('knowledge.journal.single', ['slug' => $journal->slug])) }}"
                                target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a href="https://wa.me/?text={{ urlencode(route('knowledge.journal.single', ['slug' => $journal->slug])) }}" target="_blank"
                                rel="noopener noreferrer">
                                <i class="bi bi-whatsapp"></i>
                            </a>
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('knowledge.journal.single', ['slug' => $journal->slug])) }}"
                                target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-linkedin"></i>
                            </a>
                            <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('knowledge.journal.single', ['slug' => $journal->slug])) }}"
                                target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-twitter-x"></i>
                            </a>
                            <a
                                href="mailto:?subject={{ urlencode($journal->title) }}&body={{ urlencode(route('knowledge.journal.single', ['slug' => $journal->slug])) }}">
